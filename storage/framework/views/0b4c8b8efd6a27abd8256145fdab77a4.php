...
unset($__errorArgs, $__bag); ?>" id="name" name="name" value="<?php echo e($product->name); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="price" name="price" value="<?php echo e($product->price); ?>" step="0.01" required>
...
unset($__errorArgs, $__bag); ?>" id="stock" name="stock" value="<?php echo e($product->stock); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="description" name="description" rows="4"><?php echo e($product->description); ?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <?php if($product->image_url): ?>
                                <div class="mb-3">
                                    ...
                                    <img src="<?php echo e($product->image_url); ?>" alt="<?php echo e($product->name); ?>" style="max-width: 200px; max-height: 200px; border-radius: 8px; border: 2px solid #dee2e6; object-fit: cover;">
                                </div>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel-Projects\e-commerce-system\fruit-shop\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>