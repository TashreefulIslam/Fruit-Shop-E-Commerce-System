...
<?php $__env->startSection('title', $product->name . ' - Fruit Shop'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('categories.show', $product->category->id)); ?>"><?php echo e($product->category->name); ?></a></li>
        ...
        <div class="col-lg-6">
            <div class="product-details">
                ...
                <p class="product-description">
                    <?php echo e($product->description ?? 'Premium quality ' . $product->name . ' sourced from the best farms. Fresh, organic, and delicious!'); ?>
                ...
                <?php if(auth()->guard()->check()): ?>
                    <form action="<?php echo e(route('cart.add')); ?>" method="POST">
                        ...
                        <div class="quantity-selector">
                            ...
                            <input type="number" id="quantity" name="quantity" value="1" min="1" max="<?php echo e($product->stock); ?>" class="form-control">
                ...
                <?php else: ?>
                    <div class="alert alert-info mb-3">
                        <i class="fas fa-info-circle"></i> Please <a href="<?php echo e(route('login')); ?>">login</a> to add items to cart
                    </div>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-primary w-100 mb-3">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card product-card h-100">
                            <div class="product-image">
                                <?php if($relProduct->image_url): ?>
                                    <img src="<?php echo e($relProduct->image_url); ?>" alt="<?php echo e($relProduct->name); ?>" loading="lazy">
                                <?php else: ?>
                            ...
                            <div class="product-info">
                                <h5 class="product-name"><?php echo e($relProduct->name); ?></h5>
                                <div class="product-price">₹<?php echo e(number_format($relProduct->price, 2)); ?></div>
                                <a href="<?php echo e(route('products.show', $relProduct->id)); ?>" class="btn btn-primary btn-sm w-100">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel-Projects\e-commerce-system\fruit-shop\resources\views/products/show.blade.php ENDPATH**/ ?>