...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Fruit Shop - Premium E-Commerce'); ?></title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <?php $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('categories.show', $category->id)); ?>">
                    ...
                    <li class="nav-item">
                        <form action="<?php echo e(route('products.search')); ?>" method="GET" class="d-flex ms-2">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link cart-link" href="<?php echo e(route('cart.index')); ?>">
...
<?php /**PATH D:\Laravel-Projects\e-commerce-system\fruit-shop\resources\views/layouts/app.blade.php ENDPATH**/ ?>