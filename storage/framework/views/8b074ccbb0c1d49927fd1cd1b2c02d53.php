...
<?php $__env->startSection('title', 'Order Placed - Fruit Shop'); ?>
    ...
    <div class="success-container">
        ...
        <div class="order-details-box">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value"><?php echo e($order->address); ?></span>
            </div>
            <div class="detail-row">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value"><?php echo e($order->items->sum('quantity')); ?></span>
            </div>
            <div class="detail-row">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">
                    <span class="badge bg-warning"><?php echo e($order->status); ?></span>
                </span>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel-Projects\e-commerce-system\fruit-shop\resources\views/checkout/success.blade.php ENDPATH**/ ?>