...
unset($__errorArgs, $__bag); ?>" id="price" name="price" step="0.01" required>
...
unset($__errorArgs, $__bag); ?>" id="stock" name="stock" required>
...
unset($__errorArgs, $__bag); ?>" id="description" name="description" rows="4"></textarea>
...
unset($__errorArgs, $__bag); ?>" id="image" name="image" accept="image/*" onchange="previewImage(event)">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel-Projects\e-commerce-system\fruit-shop\resources\views/admin/products/create.blade.php ENDPATH**/ ?>