...
@section('title', 'Products - Fruit Shop')
...
@section('content')
    <div class="page-title">
        ...
        <p class="text-muted">Showing {{ $products->count() }} products</p>
    </div>
            ...
            <div class="view-options">
                ...
                <div class="sort-dropdown">
                    <select class="form-select" onchange="location = this.value;">
                        <option value="{{ route('products.index') }}">Sort by: Featured</option>
                        <option value="{{ route('products.index') }}?sort=newest">Newest</option>
                        <option value="{{ route('products.index') }}?sort=price_low">Price: Low to High</option>
                        <option value="{{ route('products.index') }}?sort=price_high">Price: High to Low</option>
                    </select>
                </div>
            </div>
